...
// Максимальная площадь жилой застройки не должна превышать 40% площади участка,
// а максимальный размер гостевого дома, допустимый к строительству в этом городе равен 1000 SF.
// Также, в площадь жилой застройки не включаются гаражи до 400 SF включительно, но, если, например,
// площадь гаража = 450 SF, то в площадь жилой застройки включаются 50 SF
// Вам даны 3 параметра в Square Footage: mainHouse, garage, lot
